...
export const BODY_REGIONS: readonly BodyRegion[] = [
  { id: 'head', name: 'Head', view: 'front', zone: { x: 38, y: 3, w: 24, h: 16 }, labelSide: 'right' },
  { id: 'neck', name: 'Neck', view: 'front', zone: { x: 40, y: 21, w: 20, h: 13 }, labelSide: 'left' },
  { id: 'chest', name: 'Chest', view: 'front', zone: { x: 32, y: 36, w: 36, h: 13 }, labelSide: 'center' },
  { id: 'left-breast', name: 'L. Breast', view: 'front', zone: { x: 32, y: 51, w: 17, h: 13 }, labelSide: 'left' },
  { id: 'right-breast', name: 'R. Breast', view: 'front', zone: { x: 51, y: 51, w: 17, h: 13 }, labelSide: 'right' },
  { id: 'upper-abdomen', name: 'Upper Abdomen', view: 'front', zone: { x: 32, y: 66, w: 36, h: 13 }, labelSide: 'center' },
  { id: 'lower-abdomen', name: 'Lower Abdomen', view: 'front', zone: { x: 32, y: 81, w: 36, h: 13 }, labelSide: 'center' },
  { id: 'left-ovary', name: 'L. Ovary', view: 'front', zone: { x: 32, y: 96, w: 17, h: 13 }, labelSide: 'left' },
  { id: 'right-ovary', name: 'R. Ovary', view: 'front', zone: { x: 51, y: 96, w: 17, h: 13 }, labelSide: 'right' },
  { id: 'left-hip', name: 'L. Hip', view: 'front', zone: { x: 20, y: 110, w: 14, h: 14 }, labelSide: 'left' },
  { id: 'pelvic', name: 'Pelvic', view: 'front', zone: { x: 37, y: 110, w: 26, h: 14 }, labelSide: 'center' },
  { id: 'right-hip', name: 'R. Hip', view: 'front', zone: { x: 66, y: 110, w: 14, h: 14 }, labelSide: 'right' },
  { id: 'left-leg', name: 'L. Leg', view: 'front', zone: { x: 35, y: 126, w: 13, h: 17 }, labelSide: 'left' },
  { id: 'right-leg', name: 'R. Leg', view: 'front', zone: { x: 52, y: 126, w: 13, h: 17 }, labelSide: 'right' },
  { id: 'head-back', name: 'Head', view: 'back', zone: { x: 38, y: 3, w: 24, h: 16 }, labelSide: 'right' },
  { id: 'neck-back', name: 'Neck', view: 'back', zone: { x: 40, y: 21, w: 20, h: 13 }, labelSide: 'left' },
  { id: 'upper-back', name: 'Upper Back', view: 'back', zone: { x: 30, y: 36, w: 40, h: 26 }, labelSide: 'center' },
  { id: 'lower-back', name: 'Lower Back', view: 'back', zone: { x: 32, y: 64, w: 36, h: 22 }, labelSide: 'center' },
  { id: 'left-hip-back', name: 'L. Hip', view: 'back', zone: { x: 20, y: 88, w: 14, h: 14 }, labelSide: 'left' },
  { id: 'rectum', name: 'Rectal', view: 'back', zone: { x: 38, y: 88, w: 24, h: 14 }, labelSide: 'center' },
  { id: 'right-hip-back', name: 'R. Hip', view: 'back', zone: { x: 66, y: 88, w: 14, h: 14 }, labelSide: 'right' },
  { id: 'left-leg-back', name: 'L. Leg', view: 'back', zone: { x: 35, y: 104, w: 13, h: 17 }, labelSide: 'left' },
  { id: 'right-leg-back', name: 'R. Leg', view: 'back', zone: { x: 52, y: 104, w: 13, h: 17 }, labelSide: 'right' },
] as const;
