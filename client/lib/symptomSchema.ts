...
export const BODY_REGIONS = [
  ...
  { id: 'neck', name: 'Neck', x: 50, y: 34 },
  { id: 'chest', name: 'Chest', x: 50, y: 48 },
  { id: 'left-breast', name: 'Left Breast', x: 38, y: 52 },
  { id: 'right-breast', name: 'Right Breast', x: 62, y: 52 },
  { id: 'upper-abdomen', name: 'Upper Abdomen', x: 50, y: 62 },
  { id: 'lower-abdomen', name: 'Lower Abdomen', x: 50, y: 72 },
  { id: 'left-ovary', name: 'Left Ovary', x: 40, y: 78 },
  { id: 'right-ovary', name: 'Right Ovary', x: 60, y: 78 },
  { id: 'pelvic', name: 'Pelvic Area', x: 50, y: 85 },
  { id: 'lower-back', name: 'Lower Back', x: 50, y: 75 },
  { id: 'upper-back', name: 'Upper Back', x: 50, y: 55 },
  { id: 'left-hip', name: 'Left Hip', x: 35, y: 90 },
  { id: 'right-hip', name: 'Right Hip', x: 65, y: 90 },
  { id: 'left-leg', name: 'Left Leg', x: 42, y: 120 },
  { id: 'right-leg', name: 'Right Leg', x: 58, y: 120 },
  { id: 'rectum', name: 'Rectal Area', x: 50, y: 92 },
] as const;
