...
export const BODY_REGIONS = [
  ...
  { id: 'left-breast', name: 'Left Breast', x: 38, y: 28 },
  { id: 'right-breast', name: 'Right Breast', x: 62, y: 28 },
  { id: 'upper-abdomen', name: 'Upper Abdomen', x: 50, y: 35 },
  { id: 'lower-abdomen', name: 'Lower Abdomen', x: 50, y: 45 },
  { id: 'left-ovary', name: 'Left Ovary', x: 38, y: 48 },
  { id: 'right-ovary', name: 'Right Ovary', x: 62, y: 48 },
  { id: 'pelvic', name: 'Pelvic Area', x: 50, y: 52 },
  { id: 'lower-back', name: 'Lower Back', x: 50, y: 42 },
  { id: 'upper-back', name: 'Upper Back', x: 50, y: 28 },
  { id: 'left-hip', name: 'Left Hip', x: 32, y: 55 },
  { id: 'right-hip', name: 'Right Hip', x: 68, y: 55 },
  { id: 'left-leg', name: 'Left Leg', x: 38, y: 75 },
  { id: 'right-leg', name: 'Right Leg', x: 62, y: 75 },
  { id: 'rectum', name: 'Rectal Area', x: 50, y: 58 },
] as const;
